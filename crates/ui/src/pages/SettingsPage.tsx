...
export function SettingsPage({ onNavigateBack }: SettingsPageProps) {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      alert("AWS profile updated successfully!");
    } catch (error) {
      console.error("Failed to update profile:", error);
      alert(
        "Failed to update profile. Please check your keys and try again."
      );
    } finally {
      setIsSaving(false);
    }
      ...
      <div className="bg-gray-800 p-6 border-b border-gray-700 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold mb-2 text-blue-400">Settings</h1>
