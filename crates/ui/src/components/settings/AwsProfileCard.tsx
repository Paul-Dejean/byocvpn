...
export function AwsProfileCard({ onCredentialsSaved, onCredentialsDeleted, onProvisionRequested, isProvisioned }: AwsProfileCardProps) {
  ...
  return (
    <div className={`rounded-lg p-6 ${showNotProvisionedWarning ? "bg-gray-700 border-l-4 border-amber-500" : "bg-gray-700"}`}>
      {!isEditing ? (
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Amazon Web Services credentials for EC2 deployment</p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            <AwsIcon />
            <div>
              <h3 className="font-semibold text-lg text-white">{hasCredentials ? "Edit AWS Profile" : "Add AWS Profile"}</h3>
